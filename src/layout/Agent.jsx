...
const Agent = () => {
    const [agents, setAgents] = useState([
        { id: 1, name: "amani ben sallah", address: "123 Main St", phone: "24587410" },
        { id: 2, name: "Jamil Bensallah", address: "456 Elm St", phone: "52145625" },
        { id: 3, name: "nouha Benlahmer", address: "789 Oak St", phone: "50241568" },
        { id: 4, name: "amina loussaief", address: "789 Oak St", phone: "50241568" },
        { id: 5, name: "seif benjbali", address: "789 Oak St", phone: "50241568" },
        { id: 6, name: "aymen safir", address: "789 Oak St", phone: "50241568" },
        { id: 7, name: "boubaker ezzine", address: "789 Oak St", phone: "50241568" },
        { id: 8, name: "sarra jbali", address: "789 Oak St", phone: "50241568" },
        { id: 9, name: "samira bellghith", address: "789 Oak St", phone: "50241568" },
    ...
    return (
        <div style={styles.userContainer}>
            <h2 style={styles.h2}>Liste des Agents Immobiliers</h2>
                        ...
                        <tr key={agent.id}>
                            ...
                            <td style={styles.td}>
                                <button style={styles.editButton}>
                                    ...
                                    <Link to={`/FormAgent/${agent.id}`} state={{ agentData: agent }}>
